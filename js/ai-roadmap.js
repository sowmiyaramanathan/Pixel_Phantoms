...
async function loadRoadmap() {
    ...
    try {
        ...
        // CHANGED: Accessing the 'ai' key instead of 'web'
        const phases = data.ai.phases;
        ...
        console.error(error);
        container.innerHTML = `<div style="text-align:center; color:red;">[ERROR] DATA_STREAM_INTERRUPTED</div>`;
    }
}
